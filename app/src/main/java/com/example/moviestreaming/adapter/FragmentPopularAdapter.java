...
public class FragmentPopularAdapter extends RecyclerView.Adapter<FragmentPopularAdapter.MyViewHolder> {

    Context context;
    List<HomeMovie> homeMovies;

    public FragmentPopularAdapter(Context context , List<HomeMovie> homeMovies){
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new FragmentPopularAdapter.MyViewHolder(view);
    }
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.director.setText("Director: " + homeMovies.get(position).getDirector());
